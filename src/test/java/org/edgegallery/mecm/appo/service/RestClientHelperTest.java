...
public class RestClientHelperTest {
    ...
    public void buildHttpClient() {
        ...
        RestClientHelper restClientHelper2 = new RestClientHelper(restClientHelper.isSslEnabled(),
            restClientHelper.getTrustStorePath(), restClientHelper.getTrustStorePasswd());
    ...
    public void testProcessflowErrorResponse()
        ...
        Method method1 = AppoProcessflowServiceImpl.class
            .getDeclaredMethod("processflowErrorResponse", String.class, String.class);
    ...
    public void testUpdateSyncAppInstanceRecords() throws Exception {
        ...
        Mockito.when(appInstanceInfoService.getAppInstanceInfo(TENANT_ID, appInstanceInfoDto.getAppInstanceId()))
            .thenReturn(appInstanceInfo);

        Object[] obj1 = {TENANT_ID, "1.1.1.1", appInstanceInfoDto};
        Method method1 = AppoSyncHandler.class
            .getDeclaredMethod("updateSyncAppInstanceRecords", String.class, String.class, AppInstanceInfoDto.class);
        method1.setAccessible(true);
    ...
    public void testDeleteSyncAppInstanceRecords() throws Exception {
        ...
        Method method1 = AppoSyncHandler.class
            .getDeclaredMethod("deleteSyncAppInstanceRecords", String.class, AppInstanceDeletedDto.class);
        method1.setAccessible(true);
        method1.invoke(handler, obj1);
    }
}
